<script>
  ...
  import { HiOutlineBookOpen } from 'svelte-icons-pack/hi';
</script>
<main>
              ...
              <div class="lg:py-24">
                <div class="hidden sm:mb-5 sm:flex sm:justify-center lg:justify-start">
                  <a href="#" class="flex items-center rounded-full bg-black p-1 pr-2 text-white hover:text-gray-200 sm:text-base lg:text-sm xl:text-base">
                    ...
                    <span class="ml-4 text-sm"><Icon src={HiOutlineBookOpen} />Visit our careers page</span>
                  ...
                  <form action="#" class="sm:mx-auto sm:max-w-xl lg:mx-0">
                    <div class="sm:flex">
                      ...
                      <div class="mt-3 sm:ml-3 sm:mt-0">
                        <button type="submit" class="block w-full rounded-md bg-indigo-500 px-4 py-3 font-medium text-white shadow hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-2 focus:ring-offset-gray-900  text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2"> 
                          <Icon src={AiOutlineNodeExpand} class="w-4 h-4 me-2" aria-hidden="true" /> Get started
                        </button>
                      </div>
                    </div>
